...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-title" className={cn('font-heading text-sm font-bold', className)} {...props} />
}
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-footer" className={cn('flex items-center rounded-b-lg px-(--card-spacing) [.border-t]:pt-(--card-spacing)', className)} {...props} />
}
