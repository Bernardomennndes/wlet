  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator data-slot="checkbox-indicator" className="grid place-content-center text-current transition-none [&>svg]:size-3.5">
        {/* Exceção declarada ao "não edite o registry" (CLAUDE.md): o gerado só desenhava o ✓, e o
            estado parcial ficava idêntico ao marcado. O indicador aparece nos dois estados; quem
            escolhe o ícone é o `data-indeterminate` que o Base UI põe no root. */}
